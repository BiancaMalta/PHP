...
<div class="w3-padding-128 w3-content w3-text-grey" id="dPessoais">
  ...
  <form action="../Controller/Navegacao.php" method="post" class=" w3-row w3-light-grey w3-text-blue w3-margin w3-round-large w3-padding-large" style="width:70%;">
    ...
    <div class="w3-row w3-section">
      ...
      <div class="w3-rest">
        <input class="w3-input w3-border w3-round-large" name="cpf" type="text" placeholder="CPF" value="<?php echo unserialize($_SESSION['Usuario'])->getCPF();?>">
      </div>
    </div>
    ...
    <div class="w3-row w3-section">
      ...
      <div class="w3-rest">
        <input class="w3-input w3-border w3-round-large" name="email" type="text" placeholder="Email" value="<?php echo unserialize($_SESSION['Usuario'])->getEmail();?>">
      </div>
    </div>
      <!-- <div class="w3-row w3-section">
        <div class="w3-center">
          <button name="btnAtualizar" class="w3-button w3-block w3-blue w3-cell w3-round-large" style="width: 20%;">
            Atualizar
          </button>
        </div>
      </div> -->
...
<div class="w3-padding-128 w3-content w3-text-grey" id="formacao">
  ...
  <form action="../Controller/Navegacao.php" method="post" class="w3-round-large w3-row w3-light-grey w3-text-blue w3-margin w3-padding-large" style="width:70%;">
...
<div class="w3-padding-128 w3-content w3-text-grey" id="outrasformacoes">
  ...
  <form action="../Controller/Navegacao.php" method="post" class="w3-round-large w3-row w3-light-grey w3-text-blue w3-margin w3-padding-large" style="width:70%;">
    ...
    <div class="w3-row w3-section">
      ...
      placeholder="Descrição: Ex.: Curso de Inglês - Ingês City">
      </div>
    </div>
    <div class="w3-row w3-section">
      <div class="w3-center">
        ...
        <?php
          ...
          if($results != null)
            while($row = $results->fetch_object()) {
              ...
              echo '<td style="width: 5%;">
              <form action="../Controller/Navegacao.php" method="post">
                <input type="hidden" name="idoutrasformacoes" value="'.$row->idoutrasformacoes.'">
